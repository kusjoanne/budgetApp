...
function Item(props){
  return <tr>
    ...
    <EditItemModal id={props.id} itemName={props.itemName} itemAmount={props.itemAmount} itemDate={props.itemDate} refreshItemDates={props.refreshItemDates} getBalance={props.getBalance}/>
    </tr>;
}
